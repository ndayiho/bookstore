  ...
  render() {
    return (
      <div className="container">
        ...
        <Livres ajoute = {this.state.ajoute} fermerLivreForm ={() => this.setState({ajoute:false})}></Livres>
        <Button btnType="btn-success w-100" clic={this.ajoutLivreHandler}>{!this.state.ajoute ? "Ajouter" : "Fermer l'ajout"}</Button>
      </div>
    );
  }
